...
function newClient() {
        ...
        read -rp "Client name: " -e R_CLIENT_NAME
        ...
        read -rp "Client's WireGuard IPv4: ${BASE_IPV4}." -e -i "${DOT_IP}" DOT_IPV4
        ...
        do
				:'
					...
					plus one to last number
				'				
				CURR_IP_INDEX="$(cut -d'.' -f4 <<<"$DOT_IPV4")";
				CURR_IP_INDEX=$(($CURR_IP_INDEX + ${i}));
				CURR_IPV4=$CURR_IP_INDEX;
				CURR_IPV6=$CURR_IP_INDEX;
				CLIENT_WG_IPV4="${BASE_IPV4}.${CURR_IPV4}";
				CLIENT_WG_IPV6="${BASE_IPV6}.${CURR_IPV6}";
			
                CLIENT_NAME="${R_CLIENT_NAME}_${i}"
